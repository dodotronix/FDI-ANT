...
# Launch this script from the base redpitaya-guides/ folder inside Vivado tcl console.
# This script is modification of Anton Potocnik's basic_red_pitaya_bd.tcl and block_design.tcl files
#-------------------------------------------------------------------------------
