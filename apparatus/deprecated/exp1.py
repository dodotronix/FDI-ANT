...
if __name__ == '__main__':
    ...
    bitrate = ((2**order)-1)*1e4     # [bit/s]
    samples = get_samples('52k') # [Sa/s]
    amp = 0.5                      # [Volts]
    fsmp = 1e9                   # [Sa/s]
    ...
    def save_data(data1, data2):
        save_path = "/home/dodotronix/studium/college/fekt/semestral/data"
    ...
    while(1):
        ...
        # c = np.correlate(reflected, reference, "full")
